...
// GPU
const static size_t THREADS_PER_BLOCK = 1024;
...
#define MAX_QUERY_VERTEX 16
#define MAX_REUSE_STORE 256
#define warpId (blockDim.x * blockIdx.x + threadIdx.x >> 5)
#define warpIdinBlock (threadIdx.x >> 5)
#define threadIdinWarp (threadIdx.x & 0x1F)


const static size_t kDeviceMemoryLimits[3] = {
    (size_t)(30.0 * 1024 * 1024 * 1024), (size_t)(30.0 * 1024 * 1024 * 1024),
    (size_t)(30.0 * 1024 * 1024 * 1024)};
